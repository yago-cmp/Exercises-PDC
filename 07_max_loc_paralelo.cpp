...
int main (int argc, char *argv[]){
  ...
  #pragma omp parallel num_threads(4) private(i, maxval, maxloc) shared(max_global, maxloc_global)
  {
  ...
  printf("Maximum value: %f - Location: %d - Tempo: %ld us\n", max_global, maxloc_global, tempo);
  return 0;
}
